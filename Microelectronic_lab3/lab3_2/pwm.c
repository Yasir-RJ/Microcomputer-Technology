...
// functions added by Yasir Riyadh @ 14/2/2021 for Lab3_2
///////////////////////////////////////////////////////////////

void T1setPWMch0(int value){  // for Timer channel 0
    timer_channel_output_pulse_value_config(TIMER1,TIMER_CH_0,value); 
}
void T1setPWMch1(int value){  // for Timer channel 1
    timer_channel_output_pulse_value_config(TIMER1,TIMER_CH_1,value); 
}

void T1setPWMmotorA(int throttel){   /// for Timer channel 0 & 1
    if (throttel>0) {
